...
tl_about.to(".Scroll_heading", {
  opacity: "0",
  top: "3%"
}).to(".about_section", {
  boxShadow: "none"
}, "-=0.3").to(".about_heading h1 ", {
  top: "0px",
...
document.querySelector(".contact_section .button").addEventListener("mouseover", function () {
  document.querySelector(".button__icon__bg").style.transform = "scale(1)";
  document.querySelector(".button__icon svg").style.opacity = "1";
});
document.querySelector(".contact_section .button").addEventListener("mouseleave", function () {
